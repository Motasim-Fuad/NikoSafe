...
// Widget buildInput(TextEditingController controller, String hint, {bool obscureText = false}) {
//   return Padding(
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        Text("Remember Me ",style: TextStyle(fontSize: 15, color: AppColor.primaryTextColor),),
      ],
    ),
  );
}
...
Widget buildDropdown(String hint, RxString selected, List<String> items, AuthViewModel controller) {
  return Obx(() => Padding(
    padding: const EdgeInsets.symmetric(vertical: 8),
    child: DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
        hintText: hint,
        hintStyle:  TextStyle(color: AppColor.buttonShadeColor), // <-- your hint text color here
      ),
      dropdownColor: const Color(0xFF2B3A42),
      style:  TextStyle(color: AppColor.secondaryTextColor), // selected text color
    ),
  ));
}
...
Widget buildUploadBox(AuthViewModel controller) {
  return Column(
    ...
    children: [
       Text("Upload Profile Image", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500,color:AppColor.primaryTextColor )),
