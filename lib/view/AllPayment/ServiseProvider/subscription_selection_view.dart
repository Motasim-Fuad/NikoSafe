...
import 'package:nikosafe/view/AllPayment/ServiseProvider/payment_view.dart';
import '../widgets/subscriptionCard.dart';

class ServiseProviderSubscriptionSelectionView extends StatelessWidget {
  const ServiseProviderSubscriptionSelectionView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(ServiseProviderSubscriptionController());
  ...
  Widget _buildSubscriptionList(ServiseProviderSubscriptionController controller) {
  ...
  Widget _buildGetNowButton(ServiseProviderSubscriptionController controller) {
    ...
    return RoundButton(
      ...
      onPress: () {
        if (controller.selectedPlanId.isEmpty) {
          ...
          Get.to( ServiseProviderPaymentView());
        }
      },
    );
  }
