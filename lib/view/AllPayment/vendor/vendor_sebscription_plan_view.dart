...
import 'package:nikosafe/view/AllPayment/vendor/payment_view.dart';
import '../widgets/subscriptionCard.dart';

class VendorSubscriptionSelectionView extends StatelessWidget {
  const VendorSubscriptionSelectionView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(VendorSubscriptionController());
  ...
  Widget _buildSubscriptionList(VendorSubscriptionController controller) {
  ...
  Widget _buildGetNowButton(VendorSubscriptionController controller) {
    ...
    return RoundButton(
      ...
      onPress: () {
        if (controller.selectedPlanId.isEmpty) {
          ...
          Get.to(const VendorPaymentView());
        }
      },
    );
  }
