...
import 'package:nikosafe/View_Model/Controller/AllPayment/userController/user_payment_controller.dart';
import 'package:nikosafe/View_Model/Controller/AllPayment/vendorController/vendor_payment_controller.dart';
import 'package:nikosafe/resource/App_routes/routes_name.dart';
import 'package:nikosafe/resource/Colors/app_colors.dart';
import 'package:nikosafe/resource/compunents/RoundButton.dart';
import 'package:nikosafe/resource/compunents/customBackButton.dart';
import 'package:nikosafe/resource/compunents/elevatedbutton.dart';
import 'package:nikosafe/view/AllPayment/vendor/vendor_verification_view.dart';


import '../../../resource/asseets/image_assets.dart'; // Make sure this is your asset import

class VendorPaymentDetailsView extends StatelessWidget {
  const VendorPaymentDetailsView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(VendorPaymentController());
