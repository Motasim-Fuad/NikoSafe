// Path: View/user/chat/chat_detail_view.dart
...
class ChatDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ✅ Controller already created by binding - just find it
    final ChatController controller = Get.find<ChatController>();

    final TextEditingController messageController = TextEditingController();
    final ScrollController scrollController = ScrollController();

    // Get friend from arguments
    final ConnectUser friend = Get.arguments as ConnectUser;

    // Open chat when view loads
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.openChat(friend);
    });
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() {
                              ...
                              final isConnected = controller.selectedFriend.value != null;
