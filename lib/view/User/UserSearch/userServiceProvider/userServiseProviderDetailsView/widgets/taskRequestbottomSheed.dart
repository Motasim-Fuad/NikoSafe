...
class TaskRequestBottomSheet extends StatelessWidget {
  ...
  TaskRequestBottomSheet({super.key, required this.providerId});
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextField(
              ...
              onChanged: (_) => controller.calculateTotalAmount(), // ✅ Auto calculate
            ),
            ...
            // ✅ Show calculated total amount (read-only)
            Obx(() => Container(
