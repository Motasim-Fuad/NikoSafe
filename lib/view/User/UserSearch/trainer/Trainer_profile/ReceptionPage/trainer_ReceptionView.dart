...
import '../../../../../../View_Model/Controller/user/userSearch/trainer/tariner_booking_controller.dart';

class TrainerReceptionView extends StatelessWidget {
  TrainerReceptionView({super.key});

  final TrainerBookingController controller = Get.put(TrainerBookingController());
