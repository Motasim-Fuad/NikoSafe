                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        // Navigate back to homepage or desired screen
                        Get.offAllNamed(RouteName.userHomeView); // Example: navigate to a home route
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF66FCF1), // Teal/Cyan button color
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(25),
                        ),
                        elevation: 0,
                      ...
                      child: const Text(
                        'Back to Homepage',
                        style: TextStyle(
                          color: Color(0xFF1F2833), // Dark text color for contrast
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
