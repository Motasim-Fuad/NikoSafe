      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            detailRow("Transaction ID:", "TXN${DateTime.now().millisecondsSinceEpoch}"),
            detailRow("A/C Holder Name:", task.customerName),
            detailRow("A/C Number:", "**** **** *456"),
            detailRow("Received Amount:", task.amount),
            detailRow("Deducted Percentage:", "\$10"),
            detailRow("Final Amount:", "\$${(int.tryParse(task.amount.replaceAll(RegExp(r'[^\d]'), '')) ?? 0) - 10}"),
            const Spacer(),
            SizedBox(
