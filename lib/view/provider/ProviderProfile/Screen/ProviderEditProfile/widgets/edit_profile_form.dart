      ...
      return SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            CustomTextField(label: "Full Name", controller: controller.fullNameController),
            const SizedBox(height: 10),
            CustomTextField(label: "Job Title", controller: controller.jobTitleController),
            const SizedBox(height: 10),
            CustomTextField(label: "Email", controller: controller.emailController),
            const SizedBox(height: 10),
            CustomTextField(label: "Mobile Number", controller: controller.phoneController),
            const SizedBox(height: 10),
            CustomTextField(label: "Desired Pay Rate", controller: controller.payRateController),
            const SizedBox(height: 10),
